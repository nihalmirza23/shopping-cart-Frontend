...
import { PostProductService } from '../service/post-product.service';

@Component({
  selector: 'app-postproduct-home',
  templateUrl: './postproduct-home.component.html',
  styleUrls: ['./postproduct-home.component.css']
})
export class PostproductHomeComponent implements OnInit {
